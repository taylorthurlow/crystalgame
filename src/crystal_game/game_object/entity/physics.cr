...
module CrystalGame
  class Entity
    class Physics < Component
      ...
      property stopped_moving : Bool
      property attempting_to_move : Bool
      property pos_x : Int32
      property pos_y : Int32
      # property colliders : Array(Collider)
      ...
      def set_position(x, y, pixel : Bool = false)
        if pixel
          @pos_x = x
          @pos_y = y
        else
